...
CLASS_NAME = {0:"pedestrian", 1:"people", 2:"bicycle", 3:"car", 4:"van", 5:"truck", 6:"tricycle", 7:"awning-tricycle", 8:"bus", 9:"motor"}
COLOR_LIST = [
    # (255, 0, 0),         # 红色 (person)
    # (0, 255, 0),         # 绿色 (car)
    # (0, 0, 255),         # 蓝色 (bike)
...
def draw(images, labels, boxes, scores, thrh=0.4, font_size_factor=0.3, box_thickness_factor=0.005, class_name=None):
