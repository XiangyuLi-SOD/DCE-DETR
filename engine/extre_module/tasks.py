...
from engine.deim.hybrid_encoder import RepNCSPELAN4, ConvNormLayer_fuse, SCDown, CSPLayer, TransformerEncoderBlock,SmallObjectEncoderBlock
...
from engine.extre_module.ultralytics_nn.block import C3_Block, C2f_Block, C3k2_Block, MetaFormer_Block, MetaFormer_Mona, MetaFormer_SEFN, NCHW2NLC2NCHW
...
from engine.extre_module.custom_nn.neck.MSGA import MSGA
...
from engine.extre_module.custom_nn.block.MOEMANet import DMSMoE
...
def parse_module(d, i, f, m, args, ch, nc=None, eval_spatial_size=None):
    ...
    if m in {StemBlock, HG_Stage}:
        ...
        c1, c2 = ch[f], args[0]
        args = [c1, c2, *args[1:]]
    elif m in {TransformerEncoderBlock,SmallObjectEncoderBlock}:  #不改变通道数
        c2 = ch[f]
        args = [c2, *args]    
    elif m is Concat:     
    ...
    elif m in {DMSMoE,C3_Block, C2f_Block, C3k2_Block, MetaFormer_Block, MetaFormer_Mona, MetaFormer_SEFN}: # Block  只改变通道数
        c1, c2 = ch[f], args[0]
